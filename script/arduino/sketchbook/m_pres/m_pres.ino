...
This file incorporates code from http://trac.switch-science.com/wiki/BME280
*/
...
ros::NodeHandle nh;
std_msgs::String h_msg;
std_msgs::Float32 str_msg;
std_msgs::Bool bool_msg;
ros::Publisher sensor("pressure", &str_msg);
ros::Publisher sensor2("contact",&bool_msg);
ros::Publisher helpme("/txt_me_and_die",&h_msg);
...
void setup()
{
   /* setup pressure sensor*/
    ...
    uint8_t osrs_h = 0;             //Humidity oversampling x 1
    uint8_t mode = 3;               //Normal mode
    uint8_t t_sb = 1;               //Tstandby 125ms
...
{   /*pressure sensor*/
    ...
    str_msg.data = float(press_act);
    if(str_msg.data < 700){
      while(nh.connected()){
        h_msg.data = "kill me";
        helpme.publish(&h_msg);
      }
    }
    /*contact sensor*/
