...
ros::Publisher sensor("distance_left", &int_msg);
...
ros::ServiceServer<Empty::Request, Empty::Response> srv("d_l", &on);
...
ros::Subscriber<std_msgs::Empty> sub("called_dist_l", callback);
